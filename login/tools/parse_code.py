...
def base64_api(uname, pwd, img):
    ...
    data = {"username": uname, "password": pwd, "image": b64, 'typeid': 65}
    # http://api.ttshitu.com/imageXYPlus 这是65的汉字点选验证码的接口url
    # http://api.kuaishibie.cn/imageXYPlus 这是55的物体识别验证码的接口url
