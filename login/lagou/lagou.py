...
class LagouLoginCookies():
    ...
    def login(self):
        ...
        while not login_success:
            ...
            self.browser.find_element_by_css_selector('.forms-top-block.forms-top-password .input.login_enter_password.HtoC_JS').send_keys(self.username)
            self.browser.find_element_by_css_selector('.forms-top-block.forms-top-password input[type="password"]').send_keys(self.password)
            ...
            try:
                urllib.request.urlretrieve(img_urls, 'D:/Py-Project/CookiesPool/login/lagou/lagou_yzm.png')
            except:
                pass
            ...
            """对图片进行识别"""
            # 对接打码平台，识别验证码
            from login.lagou.parse_code import base64_api

            img_path = 'D:\\Py-Project\\CookiesPool\\login\\lagou\\lagou_yzm.png'
            ...
            if self.browser.find_element_by_css_selector('.unick'):
                login_success = True
...
if __name__ == "__main__":
    ...
    lagou = LagouLoginCookies("13232732408", "", "")
