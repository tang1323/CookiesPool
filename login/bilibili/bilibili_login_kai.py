...
class BiliBiliLoginCookies():
    ...
    def pick_code(self):
        ...
        while login_success:
            ...
            try:
                urllib.request.urlretrieve(img_urls, 'D:/Py-Project/CookiesPool/login/bilibili/bili_yzm.png')
            except:
                pass
            ...
            """对图片进行识别"""
            # 对接打码平台，识别验证码
            from login.bilibili.parse_code import base64_api

            img_path = 'D:\\Py-Project\\CookiesPool\\login\\bilibili\\bili_yzm.png'
            ...
            if self.browser.find_element_by_css_selector('.user-con.signin'):
                login_success = False
...
if __name__ == "__main__":
    bilibili = BiliBiliLoginCookies('13232732408', '130796abc')
    bilibili.crack()
